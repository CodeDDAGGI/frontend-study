  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setPosts([
        ...
        { id: 2, author:'이도경', date:'2024-05-11', title: '첫 게시물2' ,content:'리액트 커스텀 훅2'},
        { id: 3, author:'이현아', date:'2024-05-11', title: '첫 게시물3' ,content:'리액트 커스텀 훅3'},
        { id: 4, author:'정주연', date:'2024-05-11', title: '첫 게시물4' ,content:'리액트 커스텀 훅4'},
        { id: 5, author:'윤대휘', date:'2024-05-11', title: '첫 게시물5' ,content:'리액트 커스텀 훅5'},
      ]);
      setLoading(false);
    }, 1000);
  }, []);
...
export default function Board() {
  ...
  const [ selectedPost, setSelectPost ] = useState<PostType | null>(null)
  ...
  return (
    <div>
      ...
      <ul>
        {posts.map(post => (
          <li key={post.id}>
            {post.title} by {post.author} by {post.date}
